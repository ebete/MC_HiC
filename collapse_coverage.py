...
def collapse_depth(depth_file, max_gap, min_length, min_depth):
    """
    Convert the samtools depth output to a range-based depth.

    :param depth_file: Coverage file generated by samtools depth.
    :param max_gap: Maximum distance between sites before they are split into separate regions.
    :param min_length: Minimum length of a region.
    :param min_depth: Minimum median coverage of a region.
    """
